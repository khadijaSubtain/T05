 ...
 * 
 */
@WebServiceClient(name = "WelcomeImplService", targetNamespace = "http://t05.soen487.com/", wsdlLocation = "http://localhost:8088/WebServiceDemo/Welcome?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WELCOMEIMPLSERVICE_QNAME = new QName("http://t05.soen487.com/", "WelcomeImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8088/WebServiceDemo/Welcome?wsdl");
    ...
    public Welcome getWelcomePort() {
        return super.getPort(new QName("http://t05.soen487.com/", "WelcomePort"), Welcome.class);
    }
    ...
    public Welcome getWelcomePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://t05.soen487.com/", "WelcomePort"), Welcome.class, features);
    }
